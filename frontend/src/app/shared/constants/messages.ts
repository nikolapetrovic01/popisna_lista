export const MESSAGES = {
  DATE_ERROR: 'Datum početka mora biti prije datuma kraja.',
  INVENTORY_SUCCESS_MESSAGE: 'Uspješno kreirano.',
  INVENTORY_NOT_SELECTED_YET: 'Izaberi fajl ili ga prevuci',
